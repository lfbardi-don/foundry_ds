...
class FoundryDarkTheme implements FoundryThemeData {
  ...
  FoundryDarkTheme()
    : colors = const SemanticColors(
        bg: BackgroundColors(
          canvas: FColors.zinc900,
          muted: FColors.zinc700,
          emphasis: FColors.zinc600,
        ...
        border: BorderColors(
          base: FColors.zinc700,
          muted: FColors.zinc800,
          strong: FColors.zinc600,
        ...
        state: StateColors(
          hover: StateColor(bg: FColors.zinc600, fg: FColors.white),
          active: StateColor(bg: FColors.zinc500, fg: FColors.white),
          disabled: StateColor(bg: FColors.zinc800, fg: FColors.zinc600, border: FColors.zinc700),
        ),
        layout: LayoutColors(
          surface: FColors.zinc800,
          subtle: FColors.zinc900,
          elevated: FColors.zinc700,
        ...
        button: ButtonColors(
          ...
          secondary: ComponentColors(bg: FColors.white, fg: FColors.zinc900, border: FColors.transparent),
        ),
        input: InputColors(bg: FColors.zinc900, border: FColors.zinc600, placeholder: FColors.zinc500),
        card: CardColors(bg: FColors.zinc700, border: FColors.zinc600),
        navbar: NavbarColors(bg: FColors.zinc900Op80, border: FColors.zinc700),
      ),
