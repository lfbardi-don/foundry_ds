...
/// Semantic text variants for the design system.
...
/// A text widget that enforces typography tokens from the design system.
///
/// Use [FoundryText] instead of [Text] to ensure consistent typography
