...
/// Icon size variants matching [FIconSize] tokens.
enum FoundryIconSize { xs, sm, md, lg, xl, xxl }

/// A wrapper widget that enforces icon size tokens.
///
/// Use [FoundryIcon] instead of [Icon] to ensure consistent
/// icon sizing across your application.
